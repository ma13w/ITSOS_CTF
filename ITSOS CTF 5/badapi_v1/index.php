...
<head>
    ...
    <style>
        ...
        body {font-family: Arial, sans-serif;margin: 0;padding: 0;background-color: #f2f2f2;}.container {max-width: 800px;margin: 20px auto;padding: 20px;background-color: #fff;border-radius: 8px;box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);}h1 {color: #333;text-align: center;}.unavailable {color: red;text-align: center;margin-bottom: 20px;}.tips {color: blue;text-align: center;margin-top: 20px;}.button-container {display: flex;justify-content: center;}.button {padding: 10px 20px;margin: 0 10px;background-color: #007bff;color: #fff;border: none;border-radius: 5px;cursor: pointer;transition: background-color 0.3s ease;}.button:hover {background-color: #0056b3;}
    </style>
</head>
...
<body>
    <div class="container">
        ...
        <div class="button-container">
            ...
            <button class="button" onclick="window.location.href = 'getFlag.php';">Leggi la "flag"</button>
            <button class="button" onclick="window.location.href = 'getAnswer.php';">Risposte ai test</button>
        </div>
        <div class="tips">Per usufruire di altri servizi consulatre la pagina dei robot.</div>
    </div>
</body>
